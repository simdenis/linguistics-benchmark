#!/usr/bin/env python3
"""
Download all PDFs linked from https://archives.uklo.org/problems

Output layout (default under data/):
  OUTDIR/
    2010/
      uklo-2010-round1-problems.pdf
      uklo-2010-round1-solutions.pdf
      ...
    unknown_year/
      some-file.pdf
...
DEFAULT_INDEX_URL = "https://archives.uklo.org/problems"
DEFAULT_UA = "uklo-pdf-downloader/1.0 (+https://archives.uklo.org/; respectful research use)"
...
def main() -> int:
    ...
    ap.add_argument("--out", default="data/uklo_pdfs", help="Output directory")
    ap.add_argument("--years", default="all", help="e.g. all | 2010-2024 | 2012,2019")
    ap.add_argument("--langs", default="all", help="e.g. all | en,en-gb | cy,...")
